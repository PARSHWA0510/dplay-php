            ...
            <div class="element-box">
              <div class="table-responsive">
                <table class="table " id="dataTables-example">
                  ...
                  <tbody>
                    <?php								 
						$ure=mysqli_query($con,"select * from event_master where status = '1' and user_id = '$admin_id'");
                    ...
                    <tr class="showtr">
                      ...
                      <td><?php echo $urow['win_prize']; ?> </td>
                      <td><?php echo $urow['address']; ?> <?php echo $urow['state']; ?> <?php echo $urow['city']; ?> </td>
