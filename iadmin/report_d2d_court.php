    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">D2D Court Booking
              <div class="form-group floatright"> <a href="report_d2d_court.php?etype=1" target="_blank" class="btn btn-success  btn-mini">Print</a> <a href="report_d2d_court.php?etype=2" class="btn btn-success btn-mini">Excel</a>
                <?php /*?><a href="report_d2d_court.php?etype=3" target="_blank" class="btn btn-success  btn-mini">PDF</a>
...
?>
                  <script language="javascript">window.location.href="report_d2d_court.php";</script>
                  <?php } ?>
                </div>
              </div>
            </div>
            ...
            html2pdf().from(invoice).set(opt).save();
                    ...
                    <div id="invoice" class="page">
                      ...
                      <table class="table " style="width:100%" cellpadding="0" cellspacing="0" border="1" id="dataTables-example">
						...
						$ureee=("select * from user_court where payment_status = '1' $date_qry $venue_qry");
						...
						$venue_id = $urowzc['venue_id'];
						  ...
						  $urowz=mysqli_fetch_array($urez); echo $urowz['contact1']; echo '<br/>'; echo $urowz['name'];   ?>
                            ...
                            <td><?php echo $uroww['court_price']; $court_pricex[] = $uroww['court_price']; ?></td>
                          </tr>
                          <?php } ?>
                        </tbody>
                        <tfoot>
                          <tr>
                            ...
                            <th> </th>
                            <th> </th>
                            <th> <?php echo array_sum((array)($court_pricex  ?? [])); ?></th>
                          </tr>
                        </tfoot>
                      </table>
                    </div>
