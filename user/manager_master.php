    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">Sports Venue Manager</h2>
          </div>
        </div>
      </div>
    </div>
...
?>
    <script language="javascript">window.location.href="manager_master.php";</script>
    <?php 
} 
	...
	if($img0 != '')
 	{
    echo $uupQry="UPDATE user_master SET aadharcard_docs_front='$img0'  WHERE id='$id'";
	$uuresult=mysqli_query($con,$uupQry);
 	}
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for=""><strong class="btn btn-mini btn-success">Basic User Detail</strong> </label>
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label for="">Join Date </label>
                      <input placeholder="DD-MM-YYYY" class="form-control datepicker1" name="join_date"  value="<?php if($id) { echo date("d-m-Y", strtotime($urow['join_date'])); }else { echo date('Y-m-d'); } ?>" type="date" >
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input class="form-control datepicker2" placeholder="DD-MM-YYYY"  name="dob"  value="<?php echo $urow['dob']; ?>" type="text">
                    </div>
                  </div>
                  <div class="col-sm-12">
                    <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for=""><strong class="btn btn-mini btn-success">Package Detail</strong> </label>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-floating form-floating-outline">
                      <label for="multicol-username">Package Name<span style="color:#FF0000">*</span></label>
                      <select  class='form-control chosen_select' required name="package_id">
                        <option value="">Please Select</option>
                        <?php 
							$coun=mysqli_query($con,"select * from package_master where package_for = 'manager' order by name asc");
							while($Fcoun=mysqli_fetch_array($coun)) { 
							 ?>
                        <option value="<?php echo $Fcoun[0]; ?>" <?php if($Fcoun[0] == $urow['package_id']) echo 'selected="selected"';?>><?php echo $Fcoun['name']; ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label for="">Start Date<span style="color:#FF0000">*</span></label>
                      <input placeholder="DD-MM-YYYY" class="form-control" name="start_date" required  value="<?php echo $urow['start_date']; ?>" type="date" >
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label for="">End Date<span style="color:#FF0000">*</span> </label>
                      <input placeholder="DD-MM-YYYY" class="form-control" name="end_date" required  value="<?php echo $urow['end_date']; ?>" type="date" >
                    </div>
                  </div>
                  <div class="col-sm-12">
                    <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      <table width="" border="0">
                        <tr>
                          <td><strong>Master Pages </strong></td>
                          <td>&nbsp;&nbsp;
                            <input name="a1" type="checkbox"   value="1" <?php if($urow['a1'] == '1') echo 'checked="checked"';?> class="limiter"/>
                            &nbsp;Insert&nbsp;
                        ...
                        <tr>
                          <td><strong>Package Master </strong></td>
                          <td>&nbsp;&nbsp;
                            <input name="b1" type="checkbox"   value="1" <?php if($urow['b1'] == '1') echo 'checked="checked"';?> class="limiter"/>
                            &nbsp;Insert&nbsp;
                        ...
                        <tr>
                          <td><strong>Court Master </strong></td>
                          <td>&nbsp;&nbsp;
                            <input name="c1" type="checkbox"   value="1" <?php if($urow['c1'] == '1') echo 'checked="checked"';?> class="limiter"/>
                            &nbsp;Insert&nbsp;
                        ...
                        <?php /*?> <tr>
                          <td><strong>Spare Parts Master </strong></td>
                          <td>&nbsp;&nbsp;
                            <input name="d1" type="checkbox"   value="1" <?php if($urow['d1'] == '1') echo 'checked="checked"';?> class="limiter"/>
                            &nbsp;Insert&nbsp;
                        ...
                        <tr>
                          ...
                          <td>&nbsp;&nbsp;
                            <input name="e1" type="checkbox"   value="1" <?php if($urow['e1'] == '1') echo 'checked="checked"';?> class="limiter"/>
                            &nbsp;Insert&nbsp;
                        ...
                        <tr>
                          ...
                          <td>&nbsp;&nbsp;
                            <input name="f1" type="checkbox"   value="1" <?php if($urow['f1'] == '1') echo 'checked="checked"';?> class="limiter"/>
                            &nbsp;Insert&nbsp;
                        ...
                        <tr>
                          ...
                          <td>&nbsp;&nbsp;
                            <input name="g1" type="checkbox"   value="1" <?php if($urow['g1'] == '1') echo 'checked="checked"';?> class="limiter"/>
                            &nbsp;Insert&nbsp;
                        ...
                        <tr>
                          ...
                          <td>&nbsp;&nbsp;
                            <input name="h1" type="checkbox"   value="1" <?php if($urow['h1'] == '1') echo 'checked="checked"';?> class="limiter"/>
                            &nbsp;Insert&nbsp;
                        ...
                        <tr>
                          <td><strong>Store/Inventroy </strong></td>
                          <td>&nbsp;&nbsp;
                            <input name="i1" type="checkbox"   value="1" <?php if($urow['i1'] == '1') echo 'checked="checked"';?> class="limiter"/>
                            &nbsp;Insert&nbsp;
            ...
            <div class="element-box">
              <div class="table-responsive">
                <table class="table " id="dataTables-example">
                  ...
                  <tbody>
                    <?php								 
						$ure=mysqli_query($con,"select * from user_master where user_type = 'manager'");
                    ...
                    <tr class="showtr">
                      ...
                      <td class="center"><a class="btn btn-mini btn-success" href="manager_master.php?uid=<?php echo $urow[0]; ?>" title=""><i class="icon-pencil"></i></a> <a href="#" id="<?php echo $urow[0]; ?>" class="delete btn btn-mini btn-danger" title="Delete" ><i class="icon-trash"></i></a> </td>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
