...
if ($_POST['insert']) 
{
    ...
    <?php } else { 
    $sql=mysqli_query($con,"INSERT INTO `sport_type` (`name`, `status`, `image`) VALUES ('".mysqli_real_escape_string($con,$_REQUEST['name'])."','1','$img1')");	 
 	?>
                  <script language="javascript">window.location.href="sport_type.php";</script>
                  <?php 
}  }
...
if(isset($_REQUEST['update'])) 
  {
	...
	$uupQry="UPDATE sport_type SET name='".mysqli_real_escape_string($con,$_REQUEST['name'])."' WHERE id='$id'";
