...
header('Content-disposition: attachment; filename=Event-Report_'.$fds.' To '.$tds.'.xls');
}
?>
    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">D2D Event Booking
              <div class="form-group floatright"> <a href="report_d2d_event.php?etype=1" target="_blank" class="btn btn-success  btn-mini">Print</a> <a href="report_d2d_event.php?etype=2" class="btn btn-success btn-mini">Excel</a>
                <?php /*?><a href="report_d2d_event.php?etype=3" target="_blank" class="btn btn-success  btn-mini">PDF</a>
...
?>
                  <script language="javascript">window.location.href="report_d2d_event.php";</script>
                  <?php } ?>
                </div>
              </div>
            </div>
            ...
            html2pdf().from(invoice).set(opt).save();
                    ...
                    <div id="invoice" class="page">
                      ...
                      <table class="table " style="width:100%" cellpadding="0" cellspacing="0" border="1" id="dataTables-example">
						...
						$uree=mysqli_query($con,"select * from user_order where payment_status = '1' and order_type = 'eventbook' $date_qry");
