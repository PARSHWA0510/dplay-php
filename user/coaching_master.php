    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">Coaching Master</h2>
          </div>
        </div>
      </div>
    </div>
...
?>
    <script language="javascript">window.location.href="coaching_master.php";</script>
    <?php 
} 
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <textarea name="address" class="form-control" style="width:100%; height:40px"/>
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for=""><strong class="btn btn-mini btn-success">Fees & Time</strong> </label>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input class="form-control" name="coaching_fees"  value="<?php echo $urow['coaching_fees']; ?>"  type="text">
                    </div>
                  </div>
                  
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label for=""> Coaching Time </label>
                      <input class="form-control" name="coaching_time"  value="<?php echo $urow['coaching_time']; ?>"  type="text">
                    </div>
                  </div>
            ...
            <div class="element-box">
              <div class="table-responsive">
                <table class="table " id="dataTables-example">
                  ...
                  <tbody>
                    <?php								 
						if($user_type == 'admin') { $ure=mysqli_query($con,"select * from user_master where user_type = 'coaching'"); }
						if($user_type == 'manager') { $ure=mysqli_query($con,"select * from user_master where user_type = 'coaching' and manager_id = '$admin_id'"); }
                    ...
                    <tr class="showtr">
                      ...
                      <td class="center"><a class="btn btn-mini btn-success" href="coaching_master.php?uid=<?php echo $urow[0]; ?>" title=""><i class="icon-pencil"></i></a> <a href="#" id="<?php echo $urow[0]; ?>" class="delete btn btn-mini btn-danger" title="Delete" ><i class="icon-trash"></i></a> </td>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
