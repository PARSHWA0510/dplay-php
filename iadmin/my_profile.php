...
<div class="wrapper">
    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">My Profile</h2>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container mt-4 main-container">
	...
	$uupQry="UPDATE venue_master SET `username` = '".mysqli_real_escape_string($con,$_REQUEST['username'])."', `password` = '".mysqli_real_escape_string($con,$_REQUEST['password'])."', `name` = '".mysqli_real_escape_string($con,$_REQUEST['name'])."', `contact1` = '".mysqli_real_escape_string($con,$_REQUEST['contact1'])."', `contact2` = '".mysqli_real_escape_string($con,$_REQUEST['contact2'])."', `email1` = '".mysqli_real_escape_string($con,$_REQUEST['email1'])."', `salary` = '".mysqli_real_escape_string($con,$_REQUEST['salary'])."',   `address` = '".mysqli_real_escape_string($con,$_REQUEST['address'])."', `manager_id` = '".mysqli_real_escape_string($con,$_REQUEST['manager_id'])."',  `state` = '".mysqli_real_escape_string($con,$_REQUEST['state'])."', `city` = '".mysqli_real_escape_string($con,$_REQUEST['city'])."' WHERE id='$id'";
	...
	if($img0 != '')
 	{
    $uupQry="UPDATE venue_master SET aadharcard_docs_front='$img0'  WHERE id='$id'";
	$uuresult=mysqli_query($con,$uupQry);
 	}
	...
	if($img1 != '')
 	{
    $uupQry="UPDATE venue_master SET aadharcard_docs_back='$img1'  WHERE id='$id'";
	$uuresult=mysqli_query($con,$uupQry);
 	}
 
 	if($img2 != '')
 	{
    $uupQry="UPDATE venue_master SET pancard_docs='$img2'  WHERE id='$id'";
	$uuresult=mysqli_query($con,$uupQry);
 	}
  	if($img3 != '')
 	{
    $uupQry="UPDATE venue_master SET bank_upload='$img3'  WHERE id='$id'";
	$uuresult=mysqli_query($con,$uupQry);
 	}
  	if($img4 != '')
 	{
    $uupQry="UPDATE venue_master SET prv_upload='$img4'  WHERE id='$id'";
	$uuresult=mysqli_query($con,$uupQry);
	}
  
  	if($img5 != '')
 	{
    $uupQry="UPDATE venue_master SET photo='$img5'  WHERE id='$id'";
	$uuresult=mysqli_query($con,$uupQry);
 	}
 // exit();
	?>
                ...
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-floating form-floating-outline">
                      <label for="multicol-username">Venue Manager Name</label>
                      <select  class='form-control chosen_select' name="manager_id">
