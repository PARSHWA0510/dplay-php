...
$manager_email = $master_detail['cp_email'];
...
$title2 = $rser['title2'];
	 ...
	 //password set in path=Account/security/2-step verification/add password 
        ...
        $mail->isHTML(true); 
        $mail->Subject = 'Event Order Confirmed - Dplays!'; 
...
?>
<script>window.location.href="order-event.php?order_id=<?php echo $order_id; ?>";</script>
