    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">Booked Coach
            &nbsp;|&nbsp;<a href="coach_booked_export.php" class="btn btn-mini btn-primary">Excel</a> </h2>
          </div>
        </div>
      </div>
    </div>
                ...
                <div class="element-box">
                  <div class="table-responsive">
                    <table class="table " id="dataTables-example">
                      ...
                      <tbody>
                        <?php								 
						$ure=mysqli_query($con,"select * from coach_booked where manager_id = '$admin_id'");
...
{
$id=$_POST['id'];
$delete = "DELETE FROM coach_booked WHERE id = '$id'";
