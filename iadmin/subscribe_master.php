    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">Manage Subscriber
            &nbsp;|&nbsp;<a href="subscribe_export.php" class="btn btn-mini btn-primary">Excel</a> </h2>
          </div>
        </div>
      </div>
    </div>
                ...
                <div class="element-box">
                  <div class="table-responsive">
                    <table class="table " id="dataTables-example">
                      ...
                      <tbody>
                        <?php								 
						$ure=mysqli_query($con,"select * from subscribe_master");
...
{
$id=$_POST['id'];
$delete = "DELETE FROM subscribe_master WHERE id = '$id'";
