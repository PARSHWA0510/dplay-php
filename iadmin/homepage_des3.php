...
<div class="wrapper">
    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">Homepage Description 3</h2>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container mt-4 main-container">
	...
	$uupQry="UPDATE homepage_des3 SET `title1` = '".mysqli_real_escape_string($con,$_REQUEST['title1'])."', `title2` = '".mysqli_real_escape_string($con,$_REQUEST['title2'])."', `title3` = '".mysqli_real_escape_string($con,$_REQUEST['title3'])."', `title4` = '".mysqli_real_escape_string($con,$_REQUEST['title4'])."', `title5` = '".mysqli_real_escape_string($con,$_REQUEST['title5'])."', `title6` = '".mysqli_real_escape_string($con,$_REQUEST['title6'])."' WHERE id='$id'";
	...
	if($img1 != '')
 {
    $uupQry="UPDATE homepage_des3 SET image='$img1'  WHERE id='$id'";
	$uuresult=mysqli_query($con,$uupQry);
 }
 ...
 // exit();
	?>
    <script language="javascript">window.location.href="homepage_des3.php";</script>
    <?php  } ?>
    <?php 
					$ure=mysqli_query($con,"select * from homepage_des3 where id = '$id'");
            ...
            <div class="element-box">
              <form autocomplete="off"  name="form" method="post" enctype="multipart/form-data">
                ...
                <div class="col-sm-12">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label for="">Counter 1<span style="color:#FF0000">*</span></label>
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label for="">Counter 2<span style="color:#FF0000">*</span></label>
