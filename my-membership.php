...
<?php
$seo1 = mysqli_query($con,"SELECT * FROM seo_master WHERE page_name = 'My Membership'");
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-borderless">
                    ...
                    <tbody>
                      <?php								 
						$uree=mysqli_query($con,"select * from user_membership where payment_status = '1' and user_id = '$user_id' and order_type = 'membership'");
                      ...
                      <tr class="showtr">
                        ...
                        <td><?php $booking_status = $uroww['booking_status']; ?>
                        <?php if($booking_status == '0') { ?>
                        <a href="court-book-membership.php?id=<?php echo $uroww[0]; ?>" class="btn btn-primary btn-mini"><i class="feather-eye me-2"></i>Pending</a>
                        <?php } else { ?>
                        <a style="cursor:default" class="btn btn-danger btn-mini"><i class="feather-eye me-2"></i>Completed</a>
                        <?php } ?>
                        </td>
                      </tr>
                      <?php } ?>
