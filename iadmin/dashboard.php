        ...
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">
              <form name="form" method="post">
                <select  class='form-control chosen_select' name="venue" style="width:300px; display:inline">
                  ...
                  while ( $Fcoun = mysqli_fetch_array( $coun ) ) {
                    ?>
                  <option value="<?php echo $Fcoun[0]; ?>" <?php if($Fcoun[0] == $_GET['venue']) echo 'selected="selected"';?>><?php echo $Fcoun['name']; ?></option>
                  <?php } ?>
                </select>
              ...
              $today = date( 'Y-m-d' );
              ?>
              <?php $venue = $_GET['venue']; if($venue == '') { } else { $manager_qry = "and manager_id = '$venue'"; $venue_qry = "and venue_id = '$venue'"; } ?>
            </h2>
          </div>
        </div>
      </div>
...
.card-body { padding:0px !important; } 
  ...
  <div class="container mt-4 main-container">
    <div class="row">
          ...
          <div class="card-body">
            <div class="media">
              <div class="media-body">
                ...
                <h4 class="mb-0 mt-1">
                  <?php $ure=mysqli_query($con,"select * from court_master where id != '0' $venue_qry"); echo $urow=mysqli_num_rows($ure); ?>
                </h4>
              </div>
            </div>
          </div>
      ...
      <div class="col-12 col-md-6 col-lg-3"> <a href="event_master.php">
        <div class="card mb-4 primary-gradient">
          <div class="card-body">
            <div class="media">
              <div class="media-body">
                <p class="text-white mb-0">Total Event</p>
                <h4 class="mb-0 mt-1">
                  <?php $ure=mysqli_query($con,"select * from event_master where id != '0' $venue_qry"); echo $urow=mysqli_num_rows($ure); ?>
                </h4>
              </div>
            </div>
          </div>
          ...
          <div class="card-body">
            <div class="media">
              <div class="media-body">
                ...
                <h4 class="mb-0 mt-1">
                  <?php $ure=mysqli_query($con,"select * from user_court where court_date = '$today_date' and submit_status = '1' and rebook = '1'  $manager_qry"); echo $urow=mysqli_num_rows($ure); ?>
                  <span class="dynamicsparkline mt-1 float-right"></span></h4>
              </div>
              <div class="w-auto position-relative">
                <div class="text-white"><i class="material-icons icon-sm">arrow_drop_down</i>
                  <?php $ure=mysqli_query($con,"select SUM(court_price) from user_court where court_date = '$today_date' and submit_status = '1' and rebook = '1' $manager_qry"); $urow=mysqli_fetch_array($ure); echo $urow['SUM(court_price)']; ?>
                </div>
                <div class="dynamicsparkline mt-2"></div>
              </div>
            </div>
          ...
          <div class="card-body">
            <div class="media">
              <div class="media-body">
                ...
                <h4 class="mb-0 mt-1">
                  <?php $ure=mysqli_query($con,"select * from equipment_rented where inward_status = '0' $venue_qry"); echo $urow=mysqli_num_rows($ure); ?>
                  <span class="dynamicsparkline mt-1 float-right"></span></h4>
              </div>
              <div class="w-auto position-relative">
                <div class="text-white"><i class="material-icons icon-sm">arrow_drop_down</i>
                  <?php $ure=mysqli_query($con,"select SUM(total) from equipment_rented where inward_status = '0' $venue_qry"); $urow=mysqli_fetch_array($ure); echo $urow['SUM(total)']; ?>
                </div>
                <div class="dynamicsparkline mt-2"></div>
              </div>
            </div>
          ...
          <div class="card-body">
            <div class="media">
              <div class="media-body">
                ...
                <h4 class="mb-0 mt-1">
                  <?php $ure=mysqli_query($con,"select * from order_master where red_oid = '0' $venue_qry"); echo $urow=mysqli_num_rows($ure); ?>
                  <span class="dynamicsparkline mt-1 float-right"></span></h4>
              </div>
              <div class="w-auto position-relative">
                <div class="text-white"><i class="material-icons icon-sm">arrow_drop_down</i>
                  <?php $ure=mysqli_query($con,"select SUM(amount) from order_master where id != '0' $venue_qry"); $urow=mysqli_fetch_array($ure); echo $urow['SUM(amount)']; ?>
                </div>
                <div class="dynamicsparkline mt-2"></div>
              </div>
            </div>
            ...
            <div class="element-box">
              <div class="table-responsive">
                <div id="invoice" class="page">
					<center><b><?php 
					$ure=mysqli_query($con,"select * from venue_master where id = '$venue'");
                  ...
                  <table class="table" style="width:100%" cellpadding="0" cellspacing="0" border="1" id="dataTables-example">
                    ...
                    <tbody>
                      <?php
                      if ( $venue != '' ) { $venue_qry = "and venue_id = '$venue'"; }
            ...
            <div class="element-box">
              <div class="table-responsive">
                ...
                <table class="table " id="dataTables-example">
                  ...
                  <tbody>
                    <?php
                    $uree = mysqli_query( $con, "select * from user_court where submit_status = '1' and rebook = '1' $manager_qry" );
                    while ( $uroww = mysqli_fetch_array( $uree ) ) {
                    ...
                    <tr class="showtr">
                      ...
                      $urowwx = mysqli_fetch_array( $ureex );
                      echo date( "d-m-Y", strtotime( $urowwx[ 'court_date' ] ) );
                      ?>
                        <br/>
