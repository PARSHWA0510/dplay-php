...
<div class="main-wrapper coach">
  ...
  <div class="breadcrumb mb-0"> <span class="primary-right-round"></span>
    <div class="container">
      <h1 class="text-white">Court Rebook Payment</h1>
      <ul>
        <li><a href="index.php">Home</a></li>
        <li>Court Rebook Payment</li>
      </ul>
    </div>
  </div>
  <!-- /Breadcrumb -->
    ...
    <div class="container">
      <section>
        <div class="text-center mb-40">
          <?php 
		  $uretbo=mysqli_query($con,"select * from user_court where payment_status = '0' and cartid = '$cartid'");
...
$master_detailc = mysqli_fetch_array($masterc); ?>
                  <tr>
                    <td colspan="3">&nbsp;&nbsp;<a href="court-rebook.php?id=<?php echo $master_detailc[0]; ?>"><?php echo $master_detailc['name']; ?></a></td>
                  </tr>
                  <?php 
$urecd=mysqli_query($con,"select * from user_court where venue_id = '$venue_id' and court_id = '$court_id' and payment_status = '0' and cartid = '$cartid' group by court_date order by court_date asc");
...
while($urowcdc=mysqli_fetch_array($urecdc)) { ?>
                  <tr>
                    ...
                    <td><a style="padding:0px 5px" href="#" class='btn btn-mini btn-danger' onClick="performDelete('court-rebook-payment.php?slot_id=<?php echo $urowcdc[0]; ?>'); return false;">X</a></td>
                  </tr>
                  <?php } } } } ?>
                </table>
<script>
...
?>
                <script language="javascript">window.location.href="court-rebook-payment.php";</script>
                <?php  }  ?>
              </div>
            </div>
          </div>
            ...
            <aside class="card payment-modes">
              ...
              <ul class="order-sub-total">
                <li>
				  ...
				  $urexy=mysqli_query($con,"select SUM(rebook_price) from user_court where user_id = '$user_id' and payment_status = '0' and cartid = '$cartid'");
				  $urowx=mysqli_fetch_array($urexy);
				  echo $court_price = $urowx['SUM(rebook_price)'];
				  ?>
                  </h6>
                </li>
              ...
              <div class="order-total d-flex justify-content-between align-items-center">
                <h5>Order Total</h5>
                <h5>Rs
                  <?php $c1 = $court_price - $couponcode_price + $c13 + $c23 + $c33; echo $final_amt = ceil($c1);  ?>
                  <?php $uupQry=mysqli_query($con,"UPDATE user_order SET total_amount='$court_price',final_amount='$final_amt',charge1='$c13',charge2='$c23',charge3='$c33' WHERE user_id='$user_id' and payment_status = '0' and cartid = '$cartid'"); ?>
                </h5>
              </div>
...
require("checkout3/{$checkout}.php"); 
?>
<style>
.razorpay-payment-button
{   
