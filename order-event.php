...
$order_mainid = $urowtbo[0];
  ...
  <main class="grid">
    <section class="card section">
      ...
      <div class="order-meta" aria-label="Order meta"> <span>Order # <strong><?php echo $order_id; ?></strong></span> <span>Placed on <strong><?php echo date("d m Y", strtotime($urowtbo['order_datetime'])); ?> <?php echo date("h:i A", strtotime($urowtbo['order_datetime'])); ?></strong></span> </div>
    </section>
    <section class="card">
      <div class="section">
        <h2>Order Summary</h2>
...
$fullMessage = $fullMessage.'<table class="items" role="table" aria-label="Order items" border="0" style="width:100%; margin-bottom:10px" cellpadding="0" cellspacing="0">
<tr><td style="padding-left:10px; width:20%"><b style="font-size:14px">Event Name <b></td><td><span style="font-size:14px">'.$master_detail['name'].'</span></td></tr>
<tr><td style="padding-left:10px;"><b style="font-size:14px">Description <b></td><td><span style="font-size:14px">'.$master_detail['small_des'].'</span></td></tr>
<tr><td style="padding-left:10px;"><b style="font-size:14px">Event Dates <b></td><td><span style="font-size:14px">'.date("d-m-Y", strtotime($master_detail['start_datetime'])).' To '.date("d-m-Y", strtotime($master_detail['end_datetime'])).'</span></td></tr>
<tr><td style="padding-left:10px;"><b style="font-size:14px">Sport Type <b></td><td><span style="font-size:14px">'.$master_detail['sport_type'].'</span></td></tr>
</table>';

$urebe=mysqli_query($con,"select * from event_data where id = '$event_book_id'");
$master_detaile=mysqli_fetch_array($urebe); 

echo $fullMessage = $fullMessage.'<table class="items" role="table" aria-label="Order items" border="0" style="width:100%; margin-bottom:10px" cellpadding="0" cellspacing="0">
<tr><td style="padding-left:10px; width:20%"><b style="font-size:14px">Name <b></td><td><span style="font-size:14px">'.$master_detaile['data_title'].'</span></td></tr>
<tr><td style="padding-left:10px;"><b style="font-size:14px">Description <b></td><td><span style="font-size:14px">'.$master_detaile['data_description'].'</span></td></tr>
<tr><td style="padding-left:10px;"><b style="font-size:14px">Max Player <b></td><td><span style="font-size:14px">'.$master_detaile['data_max_player'].'</span></td></tr>
</table>'; ?>
      </div>
      <div class="section">
        <div class="totals">
  ...
  <tr>
    ...
    <td><?php echo $master_detail['cp_name']; ?></td>
  </tr>
  <tr>
    <td><strong>Contact No&nbsp;&nbsp;&nbsp;</strong></td>
    <td><?php echo $master_detail['cp_mobile']; ?></td>
  </tr>
  <tr>
    <td><strong>Email</strong></td>
    <td><?php echo $master_detail['cp_email']; ?></td>
  </tr>
</table>
    ...
    <section class="card section" >
      ...
      <div class="addresses" style="display:block">
        <div class="address"><?php echo $master_detail['address']; ?> <?php echo $master_detail['city']; ?> <?php echo $master_detail['state']; ?>
        </div>
