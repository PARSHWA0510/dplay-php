    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">Testimonial Master</h2>
          </div>
        </div>
      </div>
    </div>
...
if ($_POST['insert']) 
{
  ...
  $sql=("INSERT INTO `testimonial_master` ( `name`,  `designation`,  `status`, `additional_info`, `admin_status`) VALUES ( '".mysqli_real_escape_string($con,$_REQUEST['name'])."','".mysqli_real_escape_string($con,$_REQUEST['designation'])."','1', '".mysqli_real_escape_string($con,$_REQUEST['additional_info'])."','1')");	 
...
$z = mysqli_query($con,$sql);
	...
	if($img1 != '')
 {
    $uupQry="UPDATE testimonial_master SET image='$img1'  WHERE id='$id'";
	$uuresult=mysqli_query($con,$uupQry);
 }

?>
    <script language="javascript">window.location.href="testimonial_master.php";</script>
    <?php 
} 
	...
	$uupQry="UPDATE testimonial_master SET  `name` = '".mysqli_real_escape_string($con,$_REQUEST['name'])."', `designation` = '".mysqli_real_escape_string($con,$_REQUEST['designation'])."',`additional_info` = '".mysqli_real_escape_string($con,$_REQUEST['additional_info'])."' WHERE id='$id'";
	$uuresult=mysqli_query($con,$uupQry);
 ...
 // exit();
    ...
    <?php  } ?>
    <?php 
					$ure=mysqli_query($con,"select * from testimonial_master where id = '$id'");
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" name="designation"  value="<?php echo $urow['designation']; ?>" type="text">
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for=""> Testimonial Text<span class="required">*</span></label>
                      <textarea name="additional_info" class="form-control" style="width:100%; height:100px"/><?php echo $urow['additional_info']; ?></textarea>
            ...
            <div class="element-box">
              <div class="table-responsive">
                <table class="table " id="dataTables-example">
                  ...
                  <tbody>
                    <?php								 
						$ure=mysqli_query($con,"select * from testimonial_master where admin_status = '1'");
                    ...
                    <tr class="showtr">
                      ...
                      <td class="center"><a class="btn btn-mini btn-success" href="testimonial_master.php?uid=<?php echo $urow[0]; ?>" title=""><i class="icon-pencil"></i></a> <a href="#" id="<?php echo $urow[0]; ?>" class="delete btn btn-mini btn-danger" title="Delete" ><i class="icon-trash"></i></a> </td>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
...
{
$pid=$_POST['pid'];
$ure=mysqli_query($con,"select * from testimonial_master where id = '$pid'");
$urow=mysqli_fetch_array($ure);
$ostatus = $urow['status'];
if($ostatus == '1') { $status = '0'; } else { $status = '1'; }
$uupQry="UPDATE testimonial_master SET status='$status' WHERE id='$pid'";
$uuresult=mysqli_query($con,$uupQry);
}
?>
...
{
$id=$_POST['id'];
$delete = "DELETE FROM testimonial_master WHERE id = '$id'";
