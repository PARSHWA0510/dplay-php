...
<?php
$seo1 = mysqli_query($con,"SELECT * FROM seo_master WHERE page_name = 'My Batch User'");
...
<div class="main-wrapper">
  ...
  <section class="breadcrumb breadcrumb-list mb-0"> <span class="primary-right-round"></span>
    <div class="container">
      <h1 class="text-white">Batch User</h1>
      <ul>
                  ...
                  <table class="table table-borderless">
                    ...
                    <tbody>
                      <?php	
						...
						$uree=mysqli_query($con,"select * from user_order where coach_id = '$user_id' and payment_status = '1' and order_type = 'coachbook' $query");
