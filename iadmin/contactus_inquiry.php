    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">Contact Us Inquiry
            &nbsp;|&nbsp;<a href="contactus_export.php" class="btn btn-mini btn-primary">Excel</a> </h2>
          </div>
        </div>
      </div>
    </div>
                ...
                <div class="element-box">
                  <div class="table-responsive">
                    <table class="table " id="dataTables-example">
                      ...
                      <tbody>
                        <?php								 
						$ure=mysqli_query($con,"select * from contactus_inquiry");
...
{
$id=$_POST['id'];
$delete = "DELETE FROM contactus_inquiry WHERE id = '$id'";
