    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">Venue Review
            &nbsp;|&nbsp;<a href="venue_review_export.php" class="btn btn-mini btn-primary">Excel</a>
            </h2>
                ...
                <div class="element-box">
                  <div class="table-responsive">
                    <table class="table " id="dataTables-example">
                      ...
                      <tbody>
                        <?php								 
						$ure=mysqli_query($con,"select * from venue_review where manager_id = '$admin_id'");
...
{
$pid=$_POST['pid'];
$ure=mysqli_query($con,"select * from venue_review where id = '$pid'");
$urow=mysqli_fetch_array($ure);
$ostatus = $urow['status'];
if($ostatus == '1') { $status = '0'; } else { $status = '1'; }
$uupQry="UPDATE venue_review SET status='$status' WHERE id='$pid'";
...
{
$id=$_POST['id'];
$delete = "DELETE FROM venue_review WHERE id = '$id'";
