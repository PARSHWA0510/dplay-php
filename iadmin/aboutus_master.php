...
<div class="wrapper">
    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">About Us Description</h2>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container mt-4 main-container">
	...
	$uupQry="UPDATE aboutus_master SET `title1` = '".mysqli_real_escape_string($con,$_REQUEST['title1'])."', `title2` = '".mysqli_real_escape_string($con,$_REQUEST['title2'])."', `title3` = '".mysqli_real_escape_string($con,$_REQUEST['title3'])."', `title4` = '".mysqli_real_escape_string($con,$_REQUEST['title4'])."' WHERE id='$id'";
	...
	if($img1 != '')
 {
    $uupQry="UPDATE aboutus_master SET image1='$img1'  WHERE id='$id'";
	$uuresult=mysqli_query($con,$uupQry);
 }

	if($img2 != '')
 {
    $uupQry="UPDATE aboutus_master SET image2='$img2'  WHERE id='$id'";
	$uuresult=mysqli_query($con,$uupQry);
 }

	if($img3 != '')
 {
    $uupQry="UPDATE aboutus_master SET image3='$img3'  WHERE id='$id'";
	$uuresult=mysqli_query($con,$uupQry);
 }
 ...
 // exit();
	?>
    <script language="javascript">window.location.href="aboutus_master.php";</script>
    <?php  } ?>
    <?php 
					$ure=mysqli_query($con,"select * from aboutus_master where id = '$id'");
            ...
            <div class="element-box">
              <form autocomplete="off"  name="form" method="post" enctype="multipart/form-data">
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <div class="form-group">
                      <label for="">Vision<span style="color:#FF0000">*</span></label>
                      <textarea class="form-control" name="title2"  required value=""><?php echo $urow['title2']; ?></textarea>
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <div class="form-group">
                      <label for="">Mission<span style="color:#FF0000">*</span></label>
                      <textarea class="form-control" name="title4"  required value=""><?php echo $urow['title4']; ?></textarea>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <?php $image1 = $urow['image1']; if($image1 != '') { ?>
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label> Image 2 <span class="required">*</span></label>
                      <input class="form-control" name="img2"  type="file">
                      <?php $image2 = $urow['image2']; if($image2 != '') { ?>
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label> Image 3 <span class="required">*</span></label>
                      <input class="form-control" name="img3"  type="file">
                      <?php $image3 = $urow['image3']; if($image3 != '') { ?>
