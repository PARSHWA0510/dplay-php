    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">Membership Payment Completed</h2>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="element-box">
              <div class="table-responsive">
                <table class="table " id="dataTables-example">
                  ...
                  <tbody>
                    <?php								 
						$uree=mysqli_query($con,"select * from user_membership where payment_status = '1' and manager_id = '$admin_id'");
                    ...
                    <tr class="showtr">
                      ...
                      <td><?php $user_id = $uroww['user_id'];
                          ...
                          <a target="_blank" href="customer_detail.php?id=<?php echo $user_id; ?>"><?php echo $urowz['name']; echo '<br/>'; echo $urowz['contact1']; ?></a>
