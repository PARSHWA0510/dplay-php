    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">Coach Booking Payment Completed</h2>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="element-box">
              <div class="table-responsive">
                <table class="table " id="dataTables-example">
                  ...
                  <tbody>
                    <?php	
						$uree=mysqli_query($con,"select * from user_order where payment_status = '1' and order_type = 'coachbook'");
