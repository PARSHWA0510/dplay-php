...
if(isset($_REQUEST['login']))
{
	...
	$year_range = $_REQUEST['year_range'];
	  ...
	  $data = mysqli_query($con,"select * from user_master where username='$username' and password='$password' and status = '1' and user_type = 'admin'");
...
$company_logo = $row['company_logo']; ?><img src="../images/<?php echo $company_logo;?>" style="width:60%" />
