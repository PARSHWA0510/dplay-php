...
if ($success === true)
{
	...
	$uupQry="UPDATE user_court SET submit_status='1',payment_status='1',razorpay_payment_id='$razorpay_payment_id',razorpay_signature='$razorpay_signature' WHERE order_id='$order_id'";
	$uuresult=mysqli_query($con,$uupQry);
...
<div style="max-width: 800px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05); border:solid 2px #00ffcc">
  ...
  <div style="padding: 25px; border-top: 1px solid rgba(0,0,0,0.05);">
    ...
    <div style="color: #000000; font-size: 14px; margin-bottom: 30px">Your Rebook Order is Confirmed. Please check detail below.</div>
	<style>
...
<td>&nbsp;&nbsp;<strong>Rs. '.$urowcdc['rebook_price'].'</strong></td>
</tr>';
...
$title2 = $rser['title2'];
	 ...
	 //password set in path=Account/security/2-step verification/add password 
        ...
        $mail->isHTML(true); 
        $mail->Subject = 'Rebook Order Confirmed - Dplays!'; 
