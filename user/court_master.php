...
$z = mysqli_query($con,$sql);
 ...
 $ref_id = mysqli_insert_id($con);
                        ...
                        if($val != '')
                        {
                        $qry_main = "INSERT INTO `court_slot` (`court_id`,`slot_timing`,`weeekday_slot_price`,`weeekend_slot_price`,`weeekday_slot_status`,`weeekend_slot_status`,`noof_booking`,`start_time`,`end_time`,`weekday_commission`,`weekend_commission`) VALUES ('$ref_id','$val','".$_POST['weeekday_slot_price'][$key]."','".$_POST['weeekend_slot_price'][$key]."','".$_POST['weeekday_slot_status'][$key]."','".$_POST['weeekend_slot_status'][$key]."','".$_POST['noof_booking'][$key]."','".$_POST['slot_start_time'][$key]."','".$_POST['slot_end_time'][$key]."','".$_POST['weekday_commission'][$key]."','".$_POST['weekend_commission'][$key]."')";
                  ...
                  <div class="col-md-3">
                    <div class="form-floating form-floating-outline">
                      ...
                      <select  class='form-control chosen_select' name="venue_id">
                        <?php 
							$coun=mysqli_query($con,"select * from venue_master where manager_id = '$admin_id' order by name asc");
                ...
                <table class="table " id="dataTables-example">
                  ...
                  <tbody>
                    ...
                    <tr class="showtr">
                      ...
                      <td><?php $status = $urow['status']; ?><?php if($status == '0') { echo '<span class="btn btn-danger btn-mini">Pending For Approval</span>'; } else { echo '<span class="btn btn-success btn-mini">Approved</span>'; } ?> </td>
                      <?php /*?><td><div class="material-switch">
