    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">Manage Venue Rules | <a href="venue_manger.php" class="btn btn-primary" style="padding:2px 5px; font-size:14px">Back</a></h2>
          </div>
        </div>
      </div>
    </div>
...
if ($_POST['insert']) 
{
    ...
    $sql=mysqli_query($con,"INSERT INTO `venue_rules` (`venue_id`, `status`, `name`) VALUES ('".mysqli_real_escape_string($con,$_GET['id'])."','1','".mysqli_real_escape_string($con,$_REQUEST['name'])."')");	 
 	?>
                  <script language="javascript">window.location.href="venue_rules.php?id=<?php echo $_GET['id']; ?>";</script>
                  <?php 
  }
?>
                  <?php 
...
if(isset($_REQUEST['update'])) 
  {
    ...
    $uupQry="UPDATE venue_rules SET name='".mysqli_real_escape_string($con,$_REQUEST['name'])."'  WHERE id='$id'";
	...
	?>
                  ...
                  <?php  } ?>
                  <?php 
		$ure=mysqli_query($con,"select * from venue_rules where id = '$id'");
                    ...
                    <table class="table " id="dataTables-example">
                      ...
                      <tbody>
                        ...
                        <tr class="showtr">
                          ...
                          <td class="center"><a class="btn btn-mini btn-success" href="venue_rules.php?id=<?php echo $_GET['id']; ?>&uid=<?php echo $urow[0]; ?>" title=""><i class="icon-pencil"></i></a> <a href="#" id="<?php echo $urow[0]; ?>" class="delete btn btn-mini btn-danger" title="Delete" ><i class="icon-trash"></i></a> </td>
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
...
{
$pid=$_POST['pid'];
$ure=mysqli_query($con,"select * from venue_rules where id = '$pid'");
$urow=mysqli_fetch_array($ure);
$ostatus = $urow['status'];
if($ostatus == '1') { $status = '0'; } else { $status = '1'; }
$uupQry="UPDATE venue_rules SET status='$status' WHERE id='$pid'";
$uuresult=mysqli_query($con,$uupQry);
}
?>
...
{
$id=$_POST['id'];
$delete = "DELETE FROM venue_rules WHERE id = '$id'";
