...
$uupQry=mysqli_query($con,"UPDATE coach_batch_attendance SET `attendance_status` = '$id',attendance_datetime='$today_datetime' WHERE batch_id='$batch_id' and batch_date = '$batch_date' and user_id = '$id1'");
?>
