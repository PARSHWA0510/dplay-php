...
if ($_POST['insert']) 
{
	...
	$sport_type = implode(',',$_REQUEST['sport_type']);
	
    $sql=("INSERT INTO `user_master` (`username`, `password`, `name`, `contact1`, `contact2`, `email1`, `salary`, `status`, `user_type`, `join_date`, `photo`, `address`, `change_pwd`,`aadharcard_no`, `aadharcard_docs_front`, `aadharcard_docs_back`, `pancard_no`, `pancard_docs`, `bank_name`, `bank_acno`, `bank_ifsc`, `bank_upload`, `prv_pf`, `prv_esic`, `prv_mediclaim`, `prv_exp`, `prv_upload`, `data_access`, `right_service`, `right_quot`, `right_dispatch`, `right_closelead`,`venue_id`,`state`,`city`,`sport_type`,`coaching_fees`,`coaching_time`,`short_info`,`additional_info`,`dob`,`manager_id`) VALUES ('".mysqli_real_escape_string($con,$_REQUEST['username'])."', '".mysqli_real_escape_string($con,$_REQUEST['password'])."', '".mysqli_real_escape_string($con,$_REQUEST['name'])."', '".mysqli_real_escape_string($con,$_REQUEST['contact1'])."', '".mysqli_real_escape_string($con,$_REQUEST['contact2'])."', '".mysqli_real_escape_string($con,$_REQUEST['email1'])."', '".mysqli_real_escape_string($con,$_REQUEST['salary'])."', '0', 'coach', '$join_date', '".mysqli_real_escape_string($con,$_REQUEST['photo'])."', '".mysqli_real_escape_string($con,$_REQUEST['address'])."', '".mysqli_real_escape_string($con,$_REQUEST['change_pwd'])."', '".mysqli_real_escape_string($con,$_REQUEST['aadharcard_no'])."', '".mysqli_real_escape_string($con,$_REQUEST['aadharcard_docs_front'])."', '".mysqli_real_escape_string($con,$_REQUEST['aadharcard_docs_back'])."', '".mysqli_real_escape_string($con,$_REQUEST['pancard_no'])."', '".mysqli_real_escape_string($con,$_REQUEST['pancard_docs'])."', '".mysqli_real_escape_string($con,$_REQUEST['bank_name'])."', '".mysqli_real_escape_string($con,$_REQUEST['bank_acno'])."', '".mysqli_real_escape_string($con,$_REQUEST['bank_ifsc'])."', '".mysqli_real_escape_string($con,$_REQUEST['bank_upload'])."', '".mysqli_real_escape_string($con,$_REQUEST['prv_pf'])."', '".mysqli_real_escape_string($con,$_REQUEST['prv_esic'])."', '".mysqli_real_escape_string($con,$_REQUEST['prv_mediclaim'])."', '".mysqli_real_escape_string($con,$_REQUEST['prv_exp'])."', '".mysqli_real_escape_string($con,$_REQUEST['prv_upload'])."', '".mysqli_real_escape_string($con,$_REQUEST['data_access'])."', '".mysqli_real_escape_string($con,$_REQUEST['right_service'])."', '".mysqli_real_escape_string($con,$_REQUEST['right_quot'])."', '".mysqli_real_escape_string($con,$_REQUEST['right_dispatch'])."','".mysqli_real_escape_string($con,$_REQUEST['right_closelead'])."','".mysqli_real_escape_string($con,$_REQUEST['venue_id'])."','".mysqli_real_escape_string($con,$_REQUEST['state'])."','".mysqli_real_escape_string($con,$_REQUEST['city'])."','$sport_type','".mysqli_real_escape_string($con,$_REQUEST['coaching_fees'])."','".mysqli_real_escape_string($con,$_REQUEST['coaching_time'])."','".mysqli_real_escape_string($con,$_REQUEST['short_info'])."','".mysqli_real_escape_string($con,$_REQUEST['additional_info'])."','".mysqli_real_escape_string($con,$_REQUEST['dob'])."','$admin_id')");	 
            ...
            <div class="element-box">
              <div class="table-responsive">
                <table class="table " id="dataTables-example">
                  ...
                  <tbody>
                    <?php								 
						$ure=mysqli_query($con,"select * from user_master where user_type = 'coach' and manager_id = '$admin_id'");
                    ...
                    <tr class="showtr">
                      ...
                      <td><?php $status = $urow['status'];  ?>
                      <?php if($status == '0') { ?><span class="btn btn-mini btn-danger">Un-Approved</span><?php } ?>
                      <?php if($status == '1') { ?><span class="btn btn-mini btn-success">Approved</span><?php } ?>
                      </td>
