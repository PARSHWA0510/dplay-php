...
<div class="wrapper">
    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">Register Page Description</h2>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container mt-4 main-container">
	...
	$uupQry="UPDATE page_register SET `title1` = '".mysqli_real_escape_string($con,$_REQUEST['title1'])."', `title2` = '".mysqli_real_escape_string($con,$_REQUEST['title2'])."', `title3` = '".mysqli_real_escape_string($con,$_REQUEST['title3'])."' WHERE id='$id'";
	...
	if($img1 != '')
 {
    $uupQry="UPDATE page_register SET image='$img1'  WHERE id='$id'";
	$uuresult=mysqli_query($con,$uupQry);
 }
 ...
 // exit();
	?>
    <script language="javascript">window.location.href="page_register.php";</script>
    <?php  } ?>
    <?php 
					$ure=mysqli_query($con,"select * from page_register where id = '$id'");
