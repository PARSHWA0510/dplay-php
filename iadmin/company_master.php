...
document.getElementById("fill4").style.display = "block";
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" name="social_facebook"  value="<?php echo $row['social_facebook']; ?>" type="text">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for=""> Instagram Link</label>
                        <input class="form-control" name="social_instagram"  value="<?php echo $row['social_instagram']; ?>" type="text">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for=""> Linkedin Link</label>
                        <input class="form-control" name="social_linkedin"  value="<?php echo $row['social_linkedin']; ?>" type="text">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for=""> X Link</label>
                        <input class="form-control" name="social_x"  value="<?php echo $row['social_x']; ?>" type="text">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for=""> Pinterest Link</label>
                        <input class="form-control" name="social_pinterest"  value="<?php echo $row['social_pinterest']; ?>" type="text">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for=""> Youtube Link</label>
                        <input class="form-control" name="social_youtube"  value="<?php echo $row['social_youtube']; ?>" type="text">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label for=""> Google Tracking Code<span class="required">*</span></label>
                        <textarea name="google_analytic_code" id="address1" rows="5" class="form-control"><?php echo $row['google_analytic_code']; ?></textarea>
