                      ...
                      <table class="table table-striped table-bordered table-lightfont"  width="100%" border="0" id="periodTable1">
                        <thead>
                          ...
                          <?php								 
							...
							{ ?>
                          <tr class="">
                            <td style=""><?php echo $urowmm['data_title']; ?></td>
                            <td style=""><?php echo $urowmm['data_description']; ?></td>
                            <td style=""><?php echo $urowmm['data_max_player']; ?></td>
                            <td style=""><?php echo $urowmm['data_fees']; ?></td>
