    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">Coach Inquiry
            &nbsp;|&nbsp;<a href="coach_inquiry_export.php" class="btn btn-mini btn-primary">Excel</a> </h2>
          </div>
        </div>
      </div>
    </div>
...
{
$id=$_POST['id'];
$delete = "DELETE FROM coach_inquiry WHERE id = '$id'";
