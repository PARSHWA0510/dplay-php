        ...
        .addEventListener("click", () => {
            ...
            html2pdf().from(invoice).set(opt).save();
                    ...
                    <div id="invoice" class="page">
                      ...
                      <tbody>
                        <?php								 
						if($fd != '' && $td != '') { $date_qry = "and DATE(booking_datetime) between '$fd' and '$td'"; }
						if($venue_id != '') { $venue_qry = "and venue_id = '$venue_id'"; }
											 
						$ureee=("select * from coach_booked where id != '0' $date_qry $venue_qry");
						$uree = mysqli_query($con,$ureee);
						while($urow=mysqli_fetch_array($ure))
						 {
						?>
                        <tr class="showtr">
                          <td><?php echo date("d-m-y h:i A", strtotime($urow['booking_datetime'])); ?></td>
