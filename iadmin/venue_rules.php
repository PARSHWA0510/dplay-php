    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">Manage Venue Rules | <a href="venue_list.php" class="btn btn-primary" style="padding:2px 5px; font-size:14px">Back</a></h2>
          </div>
        </div>
      </div>
    </div>
