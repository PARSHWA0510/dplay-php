...
xmlhttp.open("GET","check_aadharno.php?q="+str,true);
xmlhttp.send();
}
</script>
...
xmlhttp.open("GET","check_panno.php?q="+str,true);
xmlhttp.send();
}
</script>
</head>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input class="form-control" name="contact1" value="<?php echo $urow['contact1']; ?>" type="text" id="mobile" onKeyPress="return isNumberKey(event)" maxlength="10" required >
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label for=""> Contact No 2</label>
                      <input class="form-control" name="contact2"  value="<?php echo $urow['contact2']; ?>" type="text" id="mobile2" onKeyPress="return isNumberKey(event)" maxlength="10">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input class="form-control" name="dob"  value="<?php echo $urow['dob']; ?>" type="date">
                    </div>
                  </div>
                  <div class="col-sm-12">
                    <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input class="form-control" name="aadharcard_no"  value="<?php echo $urow['aadharcard_no']; ?>" type="text" maxlength="12" onKeyPress="return (event.charCode >= 48 && event.charCode <= 57)" onKeyUp="showUser1(this.value)">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input class="form-control" name="pancard_no"  value="<?php echo $urow['pancard_no']; ?>"  type="text" onChange="showUser2(this.value)">
                      <div id="txtHint2"></div>
                    </div>
                  </div>
                  <div class="col-sm-3">
