    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">Manage Court Photo | <a href="court_master.php" class="btn btn-primary" style="padding:2px 5px; font-size:14px">Back</a></h2>
          </div>
        </div>
      </div>
    </div>
...
if ($_POST['insert']) 
{
    ...
    $sql=mysqli_query($con,"INSERT INTO `court_photo` (`court_id`, `status`, `image`) VALUES ('".mysqli_real_escape_string($con,$_GET['id'])."','1','$img1')");	 
 	?>
                  <script language="javascript">window.location.href="court_photo.php?id=<?php echo $_GET['id']; ?>";</script>
                  <?php 
  }
?>
                  <?php 
...
if(isset($_REQUEST['update'])) 
  {
	...
	if($img1 != '')
 {
    $uupQry="UPDATE court_photo SET image='$img1'  WHERE id='$id'";
                  ...
                  <form autocomplete="off" name="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <?php $image = $urow['image'];
						  if($image != '') { ?>
                      <img src="../images/<?php echo $image; ?>" width="50" style="margin-top:5px;">
                      <?php } ?>
                    </div>
                ...
                <div class="element-box">
                  <div class="table-responsive">
                    <table class="table " id="dataTables-example">
                      ...
                      <tbody>
                        <?php								 
						$ure=mysqli_query($con,"select * from court_photo");
                        ...
                        <tr class="showtr">
                          ...
                          <td class="center"><a class="btn btn-mini btn-success" href="court_photo.php?uid=<?php echo $urow[0]; ?>" title=""><i class="icon-pencil"></i></a> <a href="#" id="<?php echo $urow[0]; ?>" class="delete btn btn-mini btn-danger" title="Delete" ><i class="icon-trash"></i></a> </td>
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
...
{
$pid=$_POST['pid'];
$ure=mysqli_query($con,"select * from court_photo where id = '$pid'");
$urow=mysqli_fetch_array($ure);
$ostatus = $urow['status'];
if($ostatus == '1') { $status = '0'; } else { $status = '1'; }
$uupQry="UPDATE court_photo SET status='$status' WHERE id='$pid'";
$uuresult=mysqli_query($con,$uupQry);
}
?>
...
{
$id=$_POST['id'];
$delete = "DELETE FROM court_photo WHERE id = '$id'";
