            ...
            <div class="element-box">
              <div class="table-responsive">
                <table class="table " id="dataTables-example">
                  ...
                  <tbody>
                    <?php								 
					$z=("select * from order_master where red_oid = '0' and user_id = '$admin_id'");
...
Date : <?php echo $urowx['barcode']; ?> | Rs. <?php echo $urowx['price']; ?> * <?php echo $urowx['qty']; ?> = <?php echo $urowx['amount']; ?>%0a<?php } ?>"><img src="images/whatsapp.png" width="30"></a></td>
                      <td class="center"><a href='#'  id="<?php echo $uroww[0]; ?>" class="delete btn btn-mini btn-danger" title="Delete" ><i class="icon-trash"></i></a> </td>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
