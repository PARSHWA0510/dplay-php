...
<?php $id = $_GET['id'];
$master = mysqli_query($con,"SELECT * FROM features_master WHERE id = '$id'");
      ...
      <div class="row">
        <div class="col-sm-12 col-md-8 col-lg-8">
          ...
          <div class="featured-venues-item">
            <div class="listing-item blog-info">
              ...
              <div class="listing-content news-content"> <?php echo $master_detail['additional_info2']; ?> </div>
            </div>
          </div>
        </div>
        <div class="col-sm-12 col-md-4 col-lg-4 blog-sidebar theiaStickySidebar">
          <div class="card">
            ...
            <ul class="categories">
              <?php								 
			$ure=mysqli_query($con,"select * from features_master where status = '1'");
			while($urow=mysqli_fetch_array($ure))
			{ ?>
              <li style="list-style:square; margin-left:15px;">
                <h6><a href="features-detail.php?id=<?php echo $urow[0]; ?>"><?php echo $urow['name']; ?> </a></h6>
              </li>
              <?php } ?>
            </ul>
          </div>
