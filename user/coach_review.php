    ...
    <div class="row">
      <div class="container my-3 main-container">
        <div class="row align-items-center">
          <div class="col">
            <h2 class="content-color-primary page-title">Coach Review
              &nbsp;|&nbsp;<a href="coach_review_export.php" class="btn btn-mini btn-primary">Excel</a> </h2>
          </div>
        </div>
      </div>
    </div>
                ...
                <div class="element-box">
                  <div class="table-responsive">
                    <table class="table " id="dataTables-example">
                      ...
                      <tbody>
                        <?php								 
						$ure=mysqli_query($con,"select * from coach_review where manager_id = '$admin_id'");
					   ...
					   $urowx=mysqli_fetch_array($urex); echo $urowx['name'];?>
                          ...
                          <td><?php echo $urow['rating']; ?> </td>
                          <?php /*?><td class="center"><div class="material-switch">
                          ...
                          <td class="center"><a href="#" id="<?php echo $urow[0]; ?>" class="delete btn btn-mini btn-danger" title="Delete" ><i class="icon-trash"></i></a> </td><?php */?>
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
...
{
$pid=$_POST['pid'];
$ure=mysqli_query($con,"select * from coach_review where id = '$pid'");
$urow=mysqli_fetch_array($ure);
$ostatus = $urow['status'];
if($ostatus == '1') { $status = '0'; } else { $status = '1'; }
$uupQry="UPDATE coach_review SET status='$status' WHERE id='$pid'";
...
{
$id=$_POST['id'];
$delete = "DELETE FROM coach_review WHERE id = '$id'";
