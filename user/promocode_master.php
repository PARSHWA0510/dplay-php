...
if ($_POST['insert']) 
{
	...
	{ ?>
                  ...
                  <?php } else { 
    $sql=mysqli_query($con,"INSERT INTO `promocode_master` (`name`, `status`, `discount_per`, `discount_rs`, `discount_minvalue`, `discount_maximum`, `discount_start`, `discount_end`) VALUES ('".mysqli_real_escape_string($con,$_REQUEST['name'])."','1','".mysqli_real_escape_string($con,$_REQUEST['discount_per'])."','".mysqli_real_escape_string($con,$_REQUEST['discount_rs'])."','".mysqli_real_escape_string($con,$_REQUEST['discount_minvalue'])."','".mysqli_real_escape_string($con,$_REQUEST['discount_maximum'])."','".mysqli_real_escape_string($con,$_REQUEST['discount_start'])."','".mysqli_real_escape_string($con,$_REQUEST['discount_end'])."')");	 
 	?>
                  <script language="javascript">window.location.href="promocode_master.php";</script>
                  <?php 
}  }
...
if(isset($_REQUEST['update'])) 
  {
	...
	$uupQry="UPDATE promocode_master SET name='".mysqli_real_escape_string($con,$_REQUEST['name'])."',discount_per='".mysqli_real_escape_string($con,$_REQUEST['discount_per'])."',discount_rs='".mysqli_real_escape_string($con,$_REQUEST['discount_rs'])."',discount_minvalue='".mysqli_real_escape_string($con,$_REQUEST['discount_minvalue'])."',discount_maximum='".mysqli_real_escape_string($con,$_REQUEST['discount_maximum'])."',discount_start='".mysqli_real_escape_string($con,$_REQUEST['discount_start'])."',discount_end='".mysqli_real_escape_string($con,$_REQUEST['discount_end'])."' WHERE id='$id'";
	...
	if($img1 != '')
 {
    $uupQry="UPDATE promocode_master SET image='$img1'  WHERE id='$id'";
	$uuresult=mysqli_query($con,$uupQry);
 }
	...
	?>
		...
		$urow=mysqli_fetch_array($ure); ?>
                  <form autocomplete="off" name="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label> Discount on Minimum Value <span class="required">*</span></label>
                      <input class="form-control"   required value="<?php echo $urow['discount_minvalue']; ?>" name="discount_minvalue" type="text">
                    </div>
                    <div class="form-group">
                      <label> Maximum Discount <span class="required">*</span></label>
