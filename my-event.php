...
<?php
$seo1 = mysqli_query($con,"SELECT * FROM seo_master WHERE page_name = 'My Event'");
...
<div class="main-wrapper">
  ...
  <section class="breadcrumb breadcrumb-list mb-0"> <span class="primary-right-round"></span>
    <div class="container">
      <h1 class="text-white">Event Booked</h1>
      <ul>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-borderless">
                    ...
                    <tbody>
                      <?php								 
						$uree=mysqli_query($con,"select * from user_order where payment_status = '1' and user_id = '$user_id' and order_type = 'eventbook'");
                      ...
                      <td><?php echo date("d-m-Y", strtotime($urowz['start_datetime'])); ?> To <?php echo date("d-m-Y", strtotime($urowz['end_datetime'])); ?></td>
