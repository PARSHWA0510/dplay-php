            ...
            <div class="element-box">
              <div class="table-responsive">
                <table class="table " id="dataTables-example">
                  ...
                  <tbody>
                    <?php								 
						if($user_type == 'admin') { $ure=mysqli_query($con,"select * from user_master where user_type = 'employee'"); }
						if($user_type == 'manager') { $ure=mysqli_query($con,"select * from user_master where user_type = 'employee' and manager_id = '$admin_id'"); }
