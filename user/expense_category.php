...
if ($_POST['insert']) 
{
	...
	$ure=mysqli_query($con,"select * from expense_category where name = '$name' and venue_id = '$venue_id' and user_id = '$admin_id'");
    ...
    <?php } else { 
    $sql=mysqli_query($con,"INSERT INTO `expense_category` (`name`, `status`, `user_id`, `venue_id`) VALUES ('".mysqli_real_escape_string($con,$_REQUEST['name'])."','1','$admin_id','".mysqli_real_escape_string($con,$_REQUEST['venue_id'])."')");	 
 	?>
                  <script language="javascript">window.location.href="expense_category.php";</script>
                  <?php 
}  }
...
if(isset($_REQUEST['update'])) 
  {
	...
	$uupQry="UPDATE expense_category SET name='".mysqli_real_escape_string($con,$_REQUEST['name'])."',venue_id='".mysqli_real_escape_string($con,$_REQUEST['venue_id'])."' WHERE id='$id'";
