...
td,th { padding:1px 2px; border:solid 0.1px; font-size:10px; }
@media print{ #printButton { display: none; } #download { display: none; } } 
    body {
...
$cust_godown = $uroworder['godown_id'];
?>
<div class="page">
...
?>
    ...
    <tr>
      <td colspan="8" valign="top"><table cellpadding="0" width="100%" cellspacing="0" border="1" style="border:hidden;">
          ...
          <?php /*?><?php $couponcode = $uroworder['couponcode']; if($couponcode != '') { 
          ...
          <tr>
            ...
            <td style="text-align:right; font-size:8px"><del>&#2352;</del><strong>&nbsp; <?php echo $grand_total = number_format($total_nontaxamt,2,'.',''); ?> </strong></td>
          </tr>
    ...
    <tr>
      <td colspan="8" valign="top" style="font-size:8px"><strong> Terms and Conditions:</strong><br>
        ...
        5. All Subject to Ahmedabad Jurisdiction <br>
      </td>
    </tr>
  </table>
</div>
