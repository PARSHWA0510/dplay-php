...
if ($_POST['insert']) 
{
  ...
  $sql=mysqli_query($con,"INSERT INTO `expense_master` (`expensetype_id`,`amount`, `user_id`, `payment_date`,`insdatetime`, `small_des`, `status`) VALUES ('".mysqli_real_escape_string($con,$_REQUEST['expensetype_id'])."','".mysqli_real_escape_string($con,$_REQUEST['amount'])."', '$admin_id','".mysqli_real_escape_string($con,$_REQUEST['payment_date'])."','$todaydatetime', '".mysqli_real_escape_string($con,$_REQUEST['small_des'])."', '0')");
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <select class="form-control select2" name="expensetype_id">
                        ...
                        <?php $ures=mysqli_query($con,"select * from expense_category where status = '1' order by name asc");
