...
a.tooltipt1 span
{
    ...
    box-shadow: 5px 5px 8px #CCC;
                ...
                <table class="table " id="dataTables-example">
                  ...
                  <tbody>
                    <?php
                    $uree = mysqli_query( $con, "select * from user_order where payment_status = '1' and order_type = 'eventbook'" );
                    ...
                    <tr class="showtr">
                      ...
                      while ( $urowz = mysqli_fetch_array( $urez ) ) {
                        $event_id = $urowz[ 'event_id' ];
                        $event_accessories_id = $urowz[ 'event_accessories_id' ];
                        ?>
                        <strong>
                        <?php
                        $ureb1 = mysqli_query( $con, "select * from event_accessories where id = '$event_id'" );
                        $ureb_no1 = mysqli_fetch_array( $ureb1 );
                        echo $ureb_no1[ 'name' ];
                        ?>
                        </strong> :
                        <?php
                        $ureb2 = mysqli_query( $con, "select * from event_accessories where id = '$event_accessories_id'" );
                        $ureb_no2 = mysqli_fetch_array( $ureb2 );
                        echo $ureb_no2[ 'accessories' ];
                        ?>
                        <br/>
                        <?php } ?></td>
                      <td>
