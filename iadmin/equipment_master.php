...
if ($_POST['insert']) 
{
	...
	$name = $_REQUEST['name'];
	$ure=mysqli_query($con,"select * from equipment_master where name = '$name'");
    ...
    <?php } else { 
    $sql=mysqli_query($con,"INSERT INTO `equipment_master` (`name`, `status`, `qty`, `price`, `duration`) VALUES ('".mysqli_real_escape_string($con,$_REQUEST['name'])."','1','".mysqli_real_escape_string($con,$_REQUEST['price'])."','".mysqli_real_escape_string($con,$_REQUEST['duration'])."')");	 
 	?>
                  <script language="javascript">window.location.href="equipment_master.php";</script>
                  <?php 
}  }
...
if(isset($_REQUEST['update'])) 
  {
	...
	$uupQry="UPDATE equipment_master SET qty='".mysqli_real_escape_string($con,$_REQUEST['qty'])."',name='".mysqli_real_escape_string($con,$_REQUEST['name'])."',price='".mysqli_real_escape_string($con,$_REQUEST['price'])."',duration='".mysqli_real_escape_string($con,$_REQUEST['duration'])."' WHERE id='$id'";
